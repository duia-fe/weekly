...
-   [8 月 30 日分享（by 何宇）- 设计模式（中介者模式、混合模式、装饰模式）](https://github.com/duia-fe/weekly/blob/master/2019-08-30/README.md)

### 19 年 9 月

-   [9 月 6 日分享（by 龙佳）- 设计模式（外观模式、享元模式、代理模式）](https://github.com/duia-fe/weekly/blob/master/2019-09-06/README.md)
-   [9 月 20 日分享（by 李超凡）- 设计模式（策略模式）](https://github.com/duia-fe/weekly/blob/master/2019-09-20/README.md)
